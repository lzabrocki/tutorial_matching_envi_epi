...
Finally, we reproduce the same figure used to illustrate the issue of a lack of common support. We plot the YLL against the concentration of ozone in $t-1$ and color the points according to the heat wave status: 
...
ggsave(
  ...
  filename = here::here("3.outputs", "2.graphs", "graph_lack_support_1.pdf"),
  width = 15,
  height = 15,
  units = "cm",
  device = cairo_pdf
...
ggsave(
  ...
  filename = here::here("3.outputs", "2.graphs", "graph_lack_support_2.pdf"),
  width = 30,
  height = 20,
  units = "cm",
  device = cairo_pdf
