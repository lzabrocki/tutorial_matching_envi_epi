...
* the common support of the data is , *i.e.*, there are some treated or c The analysis will be partly based on model extrapolation: if the model is 

the lag of ozone is balanced across days with and without heat waves:
